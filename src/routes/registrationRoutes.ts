...
import { validateUser, validateUpdateUser } from '../validations';
...
router.post('/signup', validateUser, RegistrationController.signup);
router.post('/update', auth(), validateUpdateUser, RegistrationController.updateUser);
